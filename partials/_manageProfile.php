<?php
    ...
    if(isset($_POST["updateProfilePic"])){
        ...
        if($check !== false) {
            ...
            $uploaddir = $_SERVER['DOCUMENT_ROOT'].'/OnlinePizzaDelivery/OnlinePizzaDelivery/img/';
    ...
    if(isset($_POST["removeProfilePic"])){
        $filename = $_SERVER['DOCUMENT_ROOT']."/OnlinePizzaDelivery/OnlinePizzaDelivery/img/person-".$userId.".jpg";
